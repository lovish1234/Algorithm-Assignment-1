...
def Rotate_Left(Node):
    ...
    if Node1 ==None:
        ...
        Node3.right=Node2
        Node2.left=Node4
        Node2.multi_add=Node2.multi_add-Node3.multi_add
        if Node4 != None:
            Node4.parent=Node2
        if Node4.external !=1:
...
def Rotate_Left_Right(Node):
    ...
    Node4.multi_add=Node4.multi_add+Node3.multi_add
...
def Rotate_Right_Left(Node):
    ...
    if C.external!=1:
        ...
        Node5.head=C
    Node5.multi_add=Node5.multi_add - Node4.multi_add
...
def Rotate_Right(Node):
    ...
    if Node1 ==None:
        ...
        Node2.parent=Node3
        Node2.right=Node4
        Node3.multi_add=Node3.multi_add+Node2.multi_add
        if Node4 != None:
            Node4.parent=Node2
    else:
        Node1.right=Node3
        ...
        if Node1.external==1 and Node2.external==1:
           ...
           # print "here"
            ...
            while Node1.external!=1 and Node1.height != 2 :
                multi_add=multi_add + Node1.multi_add
                Node1=Node1.right
            if Node1.parent == None:
                rootNode=InNode(w)
                rootNode.left=Node1
